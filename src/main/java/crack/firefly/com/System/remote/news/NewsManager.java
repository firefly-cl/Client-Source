package crack.firefly.com.System.remote.news;
...
public class NewsManager {
	...
	private void loadNews() {
		...
		JsonObject jsonObject = HttpUtils.readJson("https://github.com/FireFlyClient-Beta/Data/blob/main/news/news.json", null);
