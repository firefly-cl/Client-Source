package crack.firefly.com.System.color;
...
public enum Theme {
	...
	// NOVO TEMA PARA "VIDRO PRETO"
	BLACK_GLASS(16, "Black Glass", new Color(0, 0, 0), new Color(15, 15, 15), new Color(255, 255, 255), new Color(200, 200, 200));
