package crack.firefly.com.System.mods.impl.asyncscreenshot;
...
import crack.firefly.com.System.mods.impl.AsyncScreenshotMod;
...
public class AsyncScreenshots extends Thread {
    ...
    public static File getTimestampedPNGFileForDirectory() {
        ...
        while (true) {
            screenshot = new File(
                Firefly.getInstance().getFileManager().getScreenshotDir(),
