...
import crack.firefly.com.menus.GuiWaypoint;
...
import crack.firefly.com.System.waypoint.Waypoint;
...
public class WaypointMod extends Mod {
	...
	public void onRender3D(EventRender3D event) {
		...
		for(Waypoint wy : Firefly.getInstance().getWaypointManager().getWaypoints()) {
			if(Firefly.getInstance().getWaypointManager().getWorld().equals(wy.getWorld())) {
