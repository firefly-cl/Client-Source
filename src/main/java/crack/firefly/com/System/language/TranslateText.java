...
public enum TranslateText {
    RGB_OUTLINE("RGB Outline"),
    CHROMA("Chroma"),
    CHROMA_SPEED("Chroma Speed"),
    LOGO("Show Logo"),
    ROUNDED("Rounded"),
    TITLES("Titles"),
    TITLES_DESCRIPTION("Customize Victory/Game Over titles position."),
    ...
    PLAYER_PREDICATOR("text.playerpredicator.name"), PLAYER_PREDICATOR_DESCRIPTION("text.playerpredicator.description"),
    INVENTORY("text.inventory.name"), INVENTORY_DESCRIPTION("text.inventory.description"), ANIMATION_TYPE("text.animationtype"),
    ...
    MIN_DAMAGE("Minimal Damage Shake"),
    MIN_BOBBING("Minimal View Bobbing"),
    HOTBAR_SCROLL("Hotbar Scroll"),
    FAST_RENDER("Fast Render"),
    GUI("GUI"),
    GUI_DESCRIPTION("Control UI sizes"),
    INVENTORY_SCALE("Inventory Scale"),
    HOTBAR_SCALE("Hotbar Scale"),
    GAP("Gap"),
    THICKNESS("Thickness"),
    DOT("Dot"),
    HIGHLIGHT_PLAYERS("Highlight Players"),
    HIGHLIGHT_HOSTILES("Highlight Hostiles"),
    HIGHLIGHT_PASSIVES("Highlight Passives"),
    PLAYER_COLOR("Player Color"),
    MOB_COLOR("Mob Color"),
    PASSIVE_COLOR("Passive Color"),
    PLAYER_RENDER_DISTANCE("Player Render Distance"),
    PASSIVE_RENDER_DISTANCE("Passive Render Distance"),
    HOSTILE_RENDER_DISTANCE("Hostile Render Distance"),
    HIDE_TALL_GRASS("Hide Tall Grass"),
    HIDE_FLOWERS("Hide Flowers"),
    HIDE_FENCES("Hide Fences"),
    HIDE_SKULLS("Hide Skulls"),
    HIDE_ITEM_FRAMES("Hide Item Frames"),
    HIDE_ARMOR_STANDS("Hide Armor Stands"), 
    HIDE_GROUND_ARROWS("Hide Ground Arrows"),
    HIDE_STUCK_ARROWS("Hide Stuck Arrows"),
    WORLD_OPTIMIZATION("World Optimization"),
    FAST_MATH("Fast Math"),
    ITEM_FAST_RENDER("Item Fast Render"),
    SMOOTH_LIGHTING("Smooth Lighting"),
    LOW_GRAPHICS("Low Graphics Mode"),
    OCCLUSION_CULLING("Occlusion Culling"),
    LAZY_CHUNK_LOADING("Lazy Chunk Loading"),
    EATING("Eating"),
    BUILD("Build"),
    ...
    SWING_17("1.7 Swing"),
    BLUR("text.blur"),
    BLUR_DESCRIPTION("text.blur.description"),
    
    // --- NO HURT CAM ---
    NO_HURT_CAM("No Hurt Cam"),
    NO_HURT_CAM_DESCRIPTION("Reduce or remove the camera shake and view bobbing."),

    // --- AURA ---
    AURA("Aura"),
    AURA_DESCRIPTION("Brilho de energia em volta do personagem"),
