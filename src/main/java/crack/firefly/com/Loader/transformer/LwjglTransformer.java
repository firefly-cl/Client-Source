package crack.firefly.com.Loader.transformer;
        ...
        if (name.equals("org.lwjgl.nanovg.NanoVGGLConfig")) {
            ...
            for (MethodNode method : node.methods) {
                if (method.name.equals("configGL")) {
                    ...
                    list.add(new TypeInsnNode(Opcodes.NEW, "crack/firefly/com/Loader/transformer/Lwjgl2FunctionProvider"));
                    list.add(new InsnNode(Opcodes.DUP));
                    list.add(new MethodInsnNode(
                        Opcodes.INVOKESPECIAL,
                            "crack/firefly/com/Loader/transformer/Lwjgl2FunctionProvider",
                        "<init>",
                        "()V",
                        false
                    ));
