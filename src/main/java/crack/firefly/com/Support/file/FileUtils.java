package crack.firefly.com.Support.file;
...
import crack.firefly.com.Support.file.filter.PngFileFilter;
import crack.firefly.com.Support.file.filter.SoundFileFilter;
...
public class FileUtils {
    ...
    public static void downloadFile(String url, File output) {
    	try {
    		...
    		FireflyConsole.error("Failed to download file: " + url, e);
    	}
    }
