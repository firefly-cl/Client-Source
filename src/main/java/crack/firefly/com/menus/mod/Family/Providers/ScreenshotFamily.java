...
import crack.firefly.com.System.screenshot.Screenshot;
...
public class ScreenshotFamily extends Category {
	...
	public ScreenshotFamily(GuiModMenu parent) {
	...
	public void initGui() {
		...
		ScreenshotManager screenshotManager = Firefly.getInstance().getScreenshotManager();
