package crack.firefly.com.menus.mod.Family.Providers.game.impl;
...
public class BirdScene extends GameScene {
	...
	public BirdScene(GamesFamily parent) {
		super(parent, "Flappy Firefly", "A terrible clone of the game Flappy Bird", LegacyIcon.PLAY);
	}
